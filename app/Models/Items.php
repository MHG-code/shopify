...
class Items extends Model
{
	...
	protected $allowedFields = [ 'title' , 'price' , 'discount'  , 'description' , 'category_id' , 'brand_id' , 'availability'];
	protected $useTimestamps = true;

	public function get_all_items($count)
	{
		return $this
					->select('items._id , images.src , items.title , items.price , items.discount , brands.brand_name , category.categories')
